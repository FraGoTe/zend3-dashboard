...
CREATE TABLE IF NOT EXISTS `pasajero` (
  ...
  INDEX `fk_pasajero_tipo_documento1_idx` (`tipo_documento_id` ASC),
  UNIQUE INDEX `tipo_documento_id_UNIQUE` (`tipo_documento_id` ASC),
  PRIMARY KEY (`id`),
  INDEX `fk_pasajero_nacionalidad1_idx` (`nacionalidad_id` ASC),
...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  INDEX `fk_user_pasajero1_idx` (`pasajero_id` ASC),
...
CREATE TABLE IF NOT EXISTS `cobro` (
  ...
  INDEX `fk_cobro_pasajero1_idx` (`pasajero_id` ASC),
...
CREATE TABLE IF NOT EXISTS `pago` (
  ...
  INDEX `fk_pago_pasajero1_idx` (`pasajero_id` ASC),
